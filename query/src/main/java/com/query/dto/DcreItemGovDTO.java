...
public class DcreItemGovDTO {
	 ...
	 private List<DcreItemStoreDTO> storeList;
	 private List<DcreItemDetailDTO> distinctItems;
	...
	public List<DcreItemStoreDTO> getStoreList() {
		return storeList;
	}
	public void setStoreList(List<DcreItemStoreDTO> storeList) {
	...
	public List<DcreItemDetailDTO> getDistinctItems() {
		return distinctItems;
	}
	public void setDistinctItems(List<DcreItemDetailDTO> distinctItems) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DcreItemGovDTO other = (DcreItemGovDTO) obj;
		if (govName == null) {
