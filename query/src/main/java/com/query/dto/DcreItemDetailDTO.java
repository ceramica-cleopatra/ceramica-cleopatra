...
public class DcreItemDetailDTO {
...
public DcreItemDetailDTO() {
	super();
}
public DcreItemDetailDTO(Integer itemId, String c, String tone) {
	super();
	this.itemId = itemId;
	this.c = c;
	this.tone = tone;
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	DcreItemDetailDTO other = (DcreItemDetailDTO) obj;
	if (itemId == null) {
