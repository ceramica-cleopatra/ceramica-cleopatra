...
@Component("dispenseStatusValidation")
public class DispenseStatusValidationImpl implements DispenseStatusValidation {

	@Override
	public void validateDateFormat(StatusDTO status, String date, Long startTime) {
		Date dispenseDate = null;
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
		try {
			dispenseDate = simpleDateFormat.parse(date);
