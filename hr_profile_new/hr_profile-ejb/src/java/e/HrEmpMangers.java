...
@NamedQueries({
    ...
    @NamedQuery(name = "HrEmpMangers.findAll", query = "SELECT h FROM HrEmpMangers h where h.empNo=:empNo or h.mngNo=:empNo"),
    @NamedQuery(name = "HrEmpMangers.findAllEmployees", query = "SELECT h FROM HrEmpMangers h where h.mngNo=:mngNo"),
