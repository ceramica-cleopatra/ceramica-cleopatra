...
//}
    ...
    public List<CrmkOrdrSader> getSaderNotApproved(Long loc_id) {
        return em.createNamedQuery("CrmkOrdrSader.findNotApproved").setParameter("loc_id", loc_id).getResultList();
    }
    ...
    public List<HrEmpMangers> findAllEmpManagers() {
        return em.createNamedQuery("HrEmpMangers.findAll").getResultList();
    }

    @Override
    public List<HrProfileMsg> findAllProfilMsgs() {
        return em.createNamedQuery("HrProfileMsg.findAll").getResultList();
    }
...
//    }
    ...
    public List<HrProfilePrifilage> findAllPrivilages(Long grp_id, Long job_id, Long loc_id, Long dept_id, Long emp_no, Long menu_id, String orderByList) {
        String sql = "SELECT * FROM Hr_Profile_Prifilage h "
                ...
                + " and   ((h.emp_id is not null and e.emp_name is not null) or h.emp_id is null) ";
        if (grp_id != null) {
