<%-- 
    Document   : salesHierarchy
    Created on : 05/06/2015, 06:34:20 ã
            ...
            <div id="sample">
                ...
                <div>
                    <textarea id="mySavedModel" style="width:1px;height:1px;visibility: hidden">
                        ${managerialHierarchy.salesHierarchy}
                    </textarea>
                </div>
            </div>

            <a href="headHierarchy.jsp" style="position: absolute;top: 15px;left: 15px;z-index: 1000;height: 30px;width: 30px" class="action-button shadow animate blue">ÚæÏÉ</a>
