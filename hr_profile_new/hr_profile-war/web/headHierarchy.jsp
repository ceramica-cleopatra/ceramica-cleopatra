<%-- 
    Document   : newjsp
    Created on : 02/06/2015, 09:18:06 ã
              ...
              if (myDiagram.isModified) {
                ...
                function nodeClick(e, obj) {
                    ...
                    if (clicked !== null) {
                        ...
                        if(thisemp.key<=300 && thisemp.key>=200)
                        {
                            window.location="https://20.1.1.46:8181/hr_profile-war-new/faces/storeHierarchy.jsp";
                        }else if(thisemp.key<=200 && 100<thisemp.key){
                            window.location="https://20.1.1.46:8181/hr_profile-war-new/faces/salesHierarchy.jsp";
                        }
                ...
                function findHeadShot(key) {
                    return "/images/dynamic/?file=" + key + ".jpg"
                };
        ...
        <div id="sample">
            ...
            <div>
                <textarea id="mySavedModel" style="width:1px;height:1px;visibility: hidden">
                    ${managerialHierarchy.headHierarchy}
                </textarea>
            </div>
        </div>
                 <a href="index_current.xhtml" style="position: absolute;top: 15px;left: 15px;z-index: 1000;height: 30px;width: 30px" class="action-button shadow animate blue">ÚæÏÉ</a>
    </form>
