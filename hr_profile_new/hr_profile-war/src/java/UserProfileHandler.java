    ...
    public void init() {
        ...
        try {
            ...
            if (jedis.hgetAll("alerts:" + usercode) != null && !jedis.hgetAll("alerts:" + usercode).isEmpty()) {
                ...
                for (String hrProfilleMsgAsString : hrProfileMsgMap.values()) {
                    try {
                        HrProfileMsg hrProfileMsg = objectMapper.readValue(hrProfilleMsgAsString, HrProfileMsg.class);
                        ...
                        Logger.getLogger(UserProfileHandler.class.getName()).log(Level.SEVERE, null, ex);
                    }
