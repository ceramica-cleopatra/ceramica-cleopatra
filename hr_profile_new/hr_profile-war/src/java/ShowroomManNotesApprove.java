        ...
        if (hrShowroomManNotes.getApproved() != null) {
            ...
            try {
                ...
                try {
                    ...
                    jedis.hset("msgs:" + hrShowroomManNotes.getManId().getEmpNo(), hrProfileMsg.getEntityName() + "" + hrProfileMsg.getMsgType() + "" + hrProfileMsg.getEmpNo() + "" + hrProfileMsg.getMsgId(), new ObjectMapper().writeValueAsString(hrProfileMsg));
                    jedis.expire("msgs:" + hrShowroomManNotes.getManId().getEmpNo(), Integer.MAX_VALUE);
                } finally {
                    if (jedis != null) {
                        jedis.close();
                ...
                Logger.getLogger(ShowroomManNotesApprove.class.getName()).log(Level.SEVERE, null, ex);
