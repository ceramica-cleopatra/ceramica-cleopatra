...
public class copy_shift_table {
    ...
    public void init() {
        ...
        getMngEmpList = CashHandler.getMngEmployees().get(Long.parseLong(usercode));
        for (HrEmpMangers hrEmpMangers : getMngEmpList) {
            Date d1 = null;
            Date d2 = null;
            Date d3 = null;
            Date d4 = null;
            Boolean b = null;
            String s = null;
            Object[] o = {hrEmpMangers, d1, d2, b, d3, d4, s};
    ...
    public void copy(ActionEvent ae) {
        ...
        for (Object[] o : shiftEmpListToPersist) {
            ...
            sessionBean.copyShiftTable(hrEmpMangers.getEmpNo(),d1, d3, d4);
//            while (d3.before(d4) || d3.equals(d4)) {
//                HrEmpTime hrEmpTime = sessionBean.getHrEmpTimeByTrnsDateAndEmpNo(hrEmpMangers.getEmpNo(), d1).get(0);
//                HrEmpTime newHrEmpTime = new HrEmpTime();
//                newHrEmpTime.setHdId(hrEmpMangers);
//                newHrEmpTime.setTrnsDate(d3);
//                newHrEmpTime.setShiftId(hrEmpTime.getShiftId());
//                newHrEmpTime.setStrtLaw(hrEmpTime.getStrtLaw());
//                newHrEmpTime.setEndLaw(hrEmpTime.getEndLaw());
//                newHrEmpTime.setPeriodLaw(hrEmpTime.getPeriodLaw());
//                newHrEmpTime.setNotes(hrEmpTime.getNotes());
//                sessionBean.persistHrEmpTime(newHrEmpTime);
//                c.setTime(d3);
...
//            if (sessionBean.chkShiftTableEntered(hrEmpMangers.getEmpNo(), new_period_from) > 0L) {
//                row[6] = "Y";
//                fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Œÿ√", " „ ≈œŒ«· ÃœÊ· «·‘Ì›  Œ·«· «·› —… «·„—«œ «·‰”Œ ›ÌÂ«"));
//                row[3] = (Object) Boolean.FALSE;
//            } else if (sessionBean.chkShiftEntry(original_period_from, original_period_to, hrEmpMangers.getEmpNo()) != ((original_period_to.getTime() - original_period_from.getTime()) / 86400000) + 1) {
//                row[6] = "Y";
