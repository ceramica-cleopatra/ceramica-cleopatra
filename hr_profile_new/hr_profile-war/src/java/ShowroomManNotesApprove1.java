        ...
        if (hrManNotesHd.getApproved() != null) {
            ...
            try {
                ...
                try {
                    ...
                    jedis.hset("msgs:" + hrManNotesHd.getMngNo().getEmpNo(), hrProfileMsg.getEntityName() + "" + hrProfileMsg.getMsgType() + "" + hrProfileMsg.getEmpNo() + "" + hrProfileMsg.getMsgId(), new ObjectMapper().writeValueAsString(hrProfileMsg));
                    jedis.expire("msgs:" + hrManNotesHd.getMngNo().getEmpNo(), Integer.MAX_VALUE);
                } finally {
                    if (jedis != null) {
                        jedis.close();
                ...
                Logger.getLogger(ShowroomManNotesApprove1.class.getName()).log(Level.SEVERE, null, ex);
